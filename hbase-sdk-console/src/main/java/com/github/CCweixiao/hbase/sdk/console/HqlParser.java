...
/**
 * @author leojie 2023/7/30 21:15
 */
public class HqlParser implements Parser {
    public enum Bracket {
        ROUND, // ()
        CURLY, // {}
        SQUARE, // []
    ...
    public HqlParser lineCommentDelims(final String[] lineCommentDelims) {
        this.lineCommentDelims = lineCommentDelims;
        return this;
    }

    public HqlParser blockCommentDelims(final BlockCommentDelims blockCommentDelims) {
        this.blockCommentDelims = blockCommentDelims;
        return this;
    }

    public HqlParser quoteChars(final char[] chars) {
        this.quoteChars = chars;
        return this;
    }

    public HqlParser escapeChars(final char[] chars) {
        this.escapeChars = chars;
        return this;
    }

    public HqlParser eofOnUnclosedQuote(boolean eofOnUnclosedQuote) {
        this.eofOnUnclosedQuote = eofOnUnclosedQuote;
        return this;
    }

    public HqlParser eofOnUnclosedBracket(Bracket... brackets) {
        setEofOnUnclosedBracket(brackets);
        return this;
    }

    public HqlParser eofOnEscapedNewLine(boolean eofOnEscapedNewLine) {
        this.eofOnEscapedNewLine = eofOnEscapedNewLine;
        return this;
    }

    public HqlParser regexVariable(String regexVariable) {
        this.regexVariable = regexVariable;
        return this;
    }

    public HqlParser regexCommand(String regexCommand) {
        this.regexCommand = regexCommand;
        return this;
    }

    public HqlParser commandGroup(int commandGroup) {
